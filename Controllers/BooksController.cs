...
namespace Todean_Daiana_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            int pageSize = 2;
            return View(await PaginatedList<Book>.CreateAsync(books.AsNoTracking().Include(a => a.Author), pageNumber ?? 1, pageSize));
        ...
        public async Task<IActionResult> EditPost(int ? id)
        {
          ...
          ViewData["AuthorID"] = new SelectList(_context.Authors, "AuthorID", "FullName", bookToUpdate.AuthorID);
